...
func Test_BreakB64RepeatingXOR(t *testing.T) {
	...
	for _, tc := range tests {
		msg, _, _ := crack.MultiByteXOR(ecrypto.MustB64ToBytes(tc.b64))
		got := string(msg)
...
func Test_HammingDistance(t *testing.T) {
	...
	for _, tc := range tests {
		got := ecrypto.HammingDistance([]byte(tc.a), []byte(tc.b))
